...
export function ThemeToggle() {
  ...
  // The server always renders with no theme context to match ("dark" is
  // just this component's SSR fallback) — swapping Sun/Moon before the
  // client has mounted would mismatch the server-rendered icon, so we
  // hold a neutral placeholder until after hydration.
